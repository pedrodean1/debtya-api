...
/** Legacy public GET /method/status and /spinwheel/status (opt-in for internal debugging). */
function isLegacyStatusRoutesAllowed() {
  return String(process.env.DEBTYA_ALLOW_LEGACY_STATUS_ROUTES || "").trim() === "1";
}
