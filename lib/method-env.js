...
/** Evita `Authorization: Bearer Bearer sk_...` si el secreto en Render incluye el prefijo. */
function normalizeMethodApiKeySecret(raw) {
...
function readFirstEnv(candidates) {
  for (const key of candidates) {
    ...
    const val = normalizeMethodApiKeySecret(raw);
