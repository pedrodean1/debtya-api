...
async function getSpinwheelMappingForUser(supabaseAdmin, debtyaUserId, environment) {
  const { data, error } = await supabaseAdmin
    ...
    .select("id, user_id, spinwheel_user_id, environment, status, raw_response, created_at, updated_at")
...
/**
 * Actualiza raw_response y status sin cambiar spinwheel_user_id (p. ej. tras verify).
 * @param {import("@supabase/supabase-js").SupabaseClient} supabaseAdmin
